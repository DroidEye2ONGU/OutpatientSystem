...
<div id="inner">
    <div id="inner2">
        <div id="inner3">
            <form method="post" action="/QueryPatientServlet">
                <br><br>&nbsp;&nbsp;<b>患者登录</b>
                <br><br><br>&nbsp;&nbsp;登录账号：<input type="text" name="patientID"><br>
                <br>&nbsp;&nbsp;密&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="password" name="patientPassword"><br>
                <br> &nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="登录">&nbsp;&nbsp;&nbsp;<input type="reset"
                                                                                                      value="重置">
                &nbsp;&nbsp;&nbsp;<a href="PatientRegisterPage.jsp">注册账号</a><br>
