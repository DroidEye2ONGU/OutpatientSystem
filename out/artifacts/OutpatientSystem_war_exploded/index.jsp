...
<head>
    ...
    <style>
        ...
        / / background-size: 1450 px 800 px;
            margin-left: auto;
            margin-right: auto;
            overflow: hidden;
        }
...
<div id="top">
    <div class="section page1">
        ...
        <div class="content">
            ...
            <p class="t">门诊收费管理系统</p>
            <div class="links">
                <a href="PatientLoginPage.jsp" target="_blank">患者登录</a>
                <a href="WorkerLoginTest.jsp" target="_blank">值班医师登录</a>
                <a href="AdminLoginPage.jsp" target="_blank">管理员登录</a>
            </div>
        </div>
    </div>
